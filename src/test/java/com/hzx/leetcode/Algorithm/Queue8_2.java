...
{ // 定义一个数组表示每个皇后在棋盘上的位置，index 表示行号，queens[index] 表示该行上的皇后所在的列号
    private int[] queens = new int[8]; // 输出八皇后问题的所有解法
    public void solve() { backtrack(0); } // 回溯算法主体函数，index 表示当前处理的行号
